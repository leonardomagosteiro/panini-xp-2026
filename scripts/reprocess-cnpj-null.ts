...
const OUTPUT_FILE = path.resolve(__dirname, '../reprocess-cnpj-null-results.json')
...
async function main() {
  console.log('=== Panini XP CNPJ-null re-reprocess (post store-signatures) ===')
  ...
  console.log('Fetching needs_review receipts where cnpj_on_receipt IS NULL...')
  ...
  console.log(`Total target receipts: ${all.length}. To process: ${all.length - alreadyProcessed}.`)
  console.log('')
  ...
  console.log('')
  console.log('========================================')
  console.log('Re-reprocess complete. Summary:')
  console.log('========================================')
